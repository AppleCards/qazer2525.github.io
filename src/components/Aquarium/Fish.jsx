...
class Fish extends Component {
  ...
  render() {
    ...
    let fishScale = { transform: `scaleX(${xScale * size}) scaleY(${yScale * size})` };
    let fishStyle = {
      ...fishScale,
      left: this.state.x,
      top: this.state.y,
      zIndex: Math.round(this.state.z) * -1,
    ...
    return (
      ...
      onMouseDown={this.handleMouseDown}
        ...
        onMouseLeave={this.handleMouseUp} // To handle cases where the cursor leaves the fish while dragging
      />
    );
  }
